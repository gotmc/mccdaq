...
// Gain contains the slope and intercept/offset values for a particular voltage
// range and a particular channel.
type Gain struct {
	Slope     float64
	Intercept float64
}

// GainTable contains all the slopes and intercepts for each voltage range and
// each channel.
